          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-4">
              ...
              >
                Hi, I'm{" "}
                <motion.span
                  className="gradient-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-[length:200%_auto]"
                  animate={{
                ...
                >
                  Gab
                  <span className="sr-only">riel Paor — React Front-End Developer</span>
                </motion.span>
              </motion.h1>
            </motion.div>
